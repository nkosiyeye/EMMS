...
namespace EMMS.Data.Migrations
{
    ...
    [Migration("20250519124417_jobManagement1.4.2")]
    partial class jobManagement142
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EMMS.Models.Asset", b =>
                {
                    ...
                    b.Property<int?>("LifespanPeriodId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EMMS.Models.Asset", b =>
                {
                    ...
                    b.HasOne("EMMS.Models.Entities.LookupItem", "LifespanPeriod")
                        .WithMany()
                        .HasForeignKey("LifespanPeriodId");
                    ...
                    b.HasOne("EMMS.Models.Entities.LookupItem", "UnitOfMeasure")
                        .WithMany()
